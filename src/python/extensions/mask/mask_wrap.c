...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_get_mask_array(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOO:get_mask_array",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5)) SWIG_fail;
  {
    array1 = obj_to_array_no_conversion(obj0, NPY_LONGLONG);
  ...
  }
  {
    ...
    if (PyList_Check(obj1)) {
      ...
      for (i = 0; i < size; i++) {
        ...
        if (PyString_Check(o))
        arg4[i] = PyString_AsString(PyList_GetItem(obj1,i));
        else {
  ...
  {
    array5 = obj_to_array_contiguous_allow_conversion(obj2, NPY_LONGLONG, &is_new_object5);
    npy_intp size[1] = {
      -1 
    };
    if (!array5 || !require_dimensions(array5, 1) || !require_size(array5, size, 1)) SWIG_fail;
    arg5 = (long long*) array_data(array5);
    arg6 = (int) array_size(array5,0);
  }
  {
    array7 = obj_to_array_contiguous_allow_conversion(obj3, NPY_LONGLONG, &is_new_object7);
    npy_intp size[1] = {
      -1 
    };
    if (!array7 || !require_dimensions(array7, 1) || !require_size(array7, size, 1)) SWIG_fail;
    arg7 = (long long*) array_data(array7);
    arg8 = (int) array_size(array7,0);
  }
  ecode9 = SWIG_AsVal_int(obj4, &val9);
  if (!SWIG_IsOK(ecode9)) {
    SWIG_exception_fail(SWIG_ArgError(ecode9), "in method '" "get_mask_array" "', argument " "9"" of type '" "int""'");
  } 
  arg9 = (int)(val9);
  ecode10 = SWIG_AsVal_int(obj5, &val10);
  if (!SWIG_IsOK(ecode10)) {
    SWIG_exception_fail(SWIG_ArgError(ecode10), "in method '" "get_mask_array" "', argument " "10"" of type '" "int""'");
  } 
  arg10 = (int)(val10);
  my_get_mask_array(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"get_mask_array", _wrap_get_mask_array, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
